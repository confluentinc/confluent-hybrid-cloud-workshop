...
We can use the MongoDB Sink Connector to stream changes from a topics to MongoDB Atlas, from here the data can be leveraged in queries and leverage the MongoDB ecosystem.
