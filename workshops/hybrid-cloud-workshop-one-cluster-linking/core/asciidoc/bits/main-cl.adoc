...
Note: if you are interested in how replicator works you can go to xref:replicator-tocloud.adoc[Replicator fron on-prem to Cloud] and execute replicator just for testing purposes.
