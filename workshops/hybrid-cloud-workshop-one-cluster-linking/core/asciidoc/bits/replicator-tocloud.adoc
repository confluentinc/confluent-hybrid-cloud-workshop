...
image::./c3_60_replicator.png[]

Select the `{dc}_sales_order_details-replicator` topic and finally the "Messages" tab under the topic heading. You should see messages streaming in from your on-premise Kafka cluster.

image::./c3_70_replicator.png[]
