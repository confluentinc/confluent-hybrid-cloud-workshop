...
[source,subs="quotes,attributes"]
----
*CREATE STREAM* product_demand_last_3mins (PRODUCT_ID STRING KEY) *WITH* (KAFKA_TOPIC='{dc}_product_demand_last_3mins', KEY_FORMAT='KAFKA', VALUE_FORMAT='AVRO', WINDOW_TYPE='HOPPING', WINDOW_SIZE='3 MINUTES');
----
====
...
== Lab {counter:labs}: Replicate Events to On-Premise Kafka
